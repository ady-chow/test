...
public class MainActivity extends FragmentActivity implements ItemListDialogFragment.Listener {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    findViewById(R.id.test_date_picker).setOnClickListener(v -> {
      testDatePicker();
    });
    findViewById(R.id.test_gallery).setOnClickListener(v -> {
      testGallery();
    });
  ...
  void testDatePicker() {
    ...
    dialog.findViewById(R.id.cancel).setOnClickListener(c -> {
      dialog.dismiss();
    });
    dialog.findViewById(R.id.ok).setOnClickListener(c -> {
      Toast.makeText(act, datePicker.getYear() + "-" + datePicker.getMonth() + "-" + datePicker.getDayOfMonth(), Toast.LENGTH_SHORT).show();
    });
    dialog.show();
  }
