 ...
 *
 * <ol>
 *   <li>plugin registered globally via {@code register} methods in this class
...
public final class RxAndroidPlugins {
   ...
   *
   * <p>Note: This should only be used for testing purposes.
   */
  @Beta
  public void reset() {
   ...
   *
   * <p>Override the default by calling {@link #registerSchedulersHook(RxAndroidSchedulersHook)} or
   * by setting the property {@code rxandroid.plugin.RxAndroidSchedulersHook.implementation} with
   ...
   *
   * @throws IllegalStateException if called more than once or after the default was initialized (if
   *     usage occurs before trying to register)
   */
